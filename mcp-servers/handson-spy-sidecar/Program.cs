...
static class Program
{
    ...
    static Dictionary<string, object?> InspectElement(AutomationElement e)
    {
        ...
        return new Dictionary<string, object?>
        {
            ...
            ["localized_control_type"] = e.Properties.LocalizedControlType.ValueOrDefault ?? "",
            ["x"] = (int)r.X,
            ["y"] = (int)r.Y,
            ["width"] = (int)r.Width,
            ["height"] = (int)r.Height,
            ...
            ["process_id"] = e.Properties.ProcessId.ValueOrDefault,
            ["native_window_handle"] = e.Properties.NativeWindowHandle.ValueOrDefault,
            ["access_key"] = e.Properties.AccessKey.ValueOrDefault ?? "",
            ["accelerator_key"] = e.Properties.AcceleratorKey.ValueOrDefault ?? "",
            ["help_text"] = e.Properties.HelpText.ValueOrDefault ?? "",
            ["item_status"] = e.Properties.ItemStatus.ValueOrDefault ?? "",
            ["item_type"] = e.Properties.ItemType.ValueOrDefault ?? "",
            ["aria_role"] = e.Properties.AriaRole.ValueOrDefault ?? "",
            ["aria_properties"] = e.Properties.AriaProperties.ValueOrDefault ?? "",
            ["is_enabled"] = e.IsEnabled,
            ["is_offscreen"] = e.IsOffscreen,
            ["has_keyboard_focus"] = e.Properties.HasKeyboardFocus.ValueOrDefault,
            ["is_keyboard_focusable"] = e.Properties.IsKeyboardFocusable.ValueOrDefault,
            ["is_password"] = e.Properties.IsPassword.ValueOrDefault,
            ["is_content_element"] = e.Properties.IsContentElement.ValueOrDefault,
            ["is_control_element"] = e.Properties.IsControlElement.ValueOrDefault,
            ["patterns"] = patterns,
        };
    }
    ...
    static AutomationElement? ResolveWindow(UIA3Automation automation, string title)
    {
        ...
        return desktop.FindFirstDescendant(cf =>
            cf.ByControlType(ControlType.Window).And(cf.ByName(title, PropertyConditionFlags.IgnoreCase)));
    }
